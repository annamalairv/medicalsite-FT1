...
const HelpSection = () => {
   let helpserv=[
    {service:"25-30% estimated savings in implementation when using Mobile Health Clinics"},
    {service:"Activate Mobile Health Clinics in just weeks"},
    {service:"Flexible, on-demand access to care services"},
    {service:"Supports referrals to provider networks and care management programs"},
...
<div className=" ">
<div className={` z-1 inset-0 text-center flex flex-col items-center justify-center bg-[#499AFA]`} style={{opacity:0.85}}>
    <div className="text-[26px] xl:text-[42px] 2xl:text-[45px] p-8 text-white">
    Learn better health outcomes, improve costs and increase productivity for your business
    </div>
            ...
            return(
                <div className="flex flex-col   w-3/5 ">
                       <div className="flex items-center ">
                            ...
                            <div className="text-primary pl-2 mt-1">
                           {prop.service}
                            </div>
                        </div>
                    </div>
