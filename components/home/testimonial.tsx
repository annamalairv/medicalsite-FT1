  ...
  function Slide() {
    return (
      <div className="h-72 flex gap-4  pt-2 md:pt-4">
        ...
        <div className="lora-regular md:text-lg lg:text-2xl xl:text-3xl  flex-1">
    ...
    <div className="bg-slate-200 my-10">
      <div className="grid grid-cols-1 md:grid-cols-2  pr-4 lg:pr-10 xl:pr-20 ">
        ...
        <div className="px-4 md:px-6 lg:px-10 pt-4 md:pt-6 lg:pt-10">
          <div className="text-tertiary pb-4 lora-semibold">Our Testimonials</div>
          <div className="text-3xl md:text-4xl lg:text-5xl pb-4 lora-bold">What Our Patients Say</div>
