...
const Appointment: React.FC<AppointmentProps> = () => {
    ...
    return (
        <div className="">
            <div className={`hidden md:flex items-center justify-center relative`} style={{ height: `${patternHeight}px` }}>
                ...
                <div className=" mt-10">
                    <div className="p-2 px-8 xl:p-4 xl:px-12 rounded-full bg-secondary text-center  lg:text-xl xl:text-2xl 2xl:text-4xl text-white">
                        Make an Appointment +
                    </div>
                </div>
                    </div>
