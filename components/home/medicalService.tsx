  ...
  return (
    <div className="w-full min-h-screen bg-blue-50 p-6 px-30">
        <div className="grid place-content-center h-full  text-center container mx-auto">
                ...
                <div className="text-[50px] text-[#0E204D]  ">
                Benefit For Physical Mental and<br/> Virtual Care
                </div>
        ...
        <div className="w-full grid sm:grid-cols-3 grid-cols-2 gap-4 text-center px-20 sm:px-20 py-8 ">
{techs.map((prop)=>{
  return(
