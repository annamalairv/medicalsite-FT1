...
return (
    <div className="bg-[#499afa] p-8 md:p-12 xl:p-18 rounded-lg shadow h-full">
        ...
        <div className="text-white text-lg py-1">Phone-No :  +91 494192383</div>
        <div className="text-white text-lg py-1">E-mail :  ravan@gmail.com</div>
        <div className="text-white text-lg py-1">Mobile :  +91 9393823834</div>
