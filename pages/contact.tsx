...
export default function ContactPage() {
    const [breadCrumbsProps,setBreadCrumbsProps]= useState<BreadCrumbsProps>(new BreadCrumbsProps({backgroundColor:"#2e279d",backgroundImage:"assets/images/contact-breadcrum-background.jpg",title:"Contact Us",textColor:"white",previous:"Home",}))
    return (
    <div className="">
